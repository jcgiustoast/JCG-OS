...
# Professional — Mars Men

## Company Overview
- **Brand:** Mars Men (mengotomars.com)
- **Product:** Natural testosterone supplement for men — subscription-based DTC
- **Revenue:** ~$100M/year run rate (as of March 2026)
- **Funding:** $27.5M Series A led by L Catterton (announced March 30, 2026)
- **Stage:** Post-Series A, scaling aggressively. Under 18 months since launch. Profitable prior to raise.
- **Origin story:** Co-founder Benjamin Smith increased his testosterone from 320 to 847 in 97 days without TRT. Built the brand around that narrative.
...
- **Retention / Subscription:** Reducing churn, improving LTV, subscription UX
- **Acquisition (support):** Helps with acquisition strategy but does NOT own creatives or ad spend (that's Raheel)
- **LP & Website Leadership:** Leads design, development, and copy for landing pages and website creation
...
## Career History
1. **Product Hackers** (Spain) — CRO agency. Started in CRO/experimentation. Worked with Blue Banana, PDaola, HOFF.
2. **Sharma Brands** — Experimentation Strategist. Worked with Parachute, David Protein, Little Words Project.
3. **Mars Men** (current) — Head of eCommerce. Owns website conversion rate, experimentation roadmap. Leads design, copywriting, and dev team for landing pages, website changes, and experiments. Does not touch ad spend or acquisition directly.

## Career Goals
- Become a recognized, top-tier eCommerce operator — the caliber of Zach Stuck or Taylor Holiday
- Build distribution and trust as a personal brand in DTC — sees this as the durable edge in the AI era
- Build ASTEROI into a SEAN (Software-Enabled Agency Network) modeled after CTC but with AI-native tooling
- Financial independence: $5M-$10M net worth by 2036, with ASTEROI as the primary vehicle
- **Transition plan:** Use remaining ~12 months at Mars Men to build personal brand credibility ("Head of eComm at 9-figure brand backed by L Catterton"), then go public with ASTEROI as founder
