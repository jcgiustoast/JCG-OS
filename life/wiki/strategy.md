...
|-----------|--------------|
| Age | 31 |
| Net worth | ~$100K (likely going to mortgage) |
...
| ASTEROI team | Juan (maxed out) + Tincho (split with 18PM, can't go public) |
| Tools in active use | 3 of 6 (Ad Creative System, Meta Ads Deployer, Sense) |
...
**Duration:** ~12 months
**Objective:** Build personal brand, resolve Tincho bottleneck, get ASTEROI to $25-30K/month gross.
...
> **UPDATE 2026-07-20 (CONFIRMED):** Tincho goes **fully operational ~early August 2026** — off 18PM, full-time, free to front/operate/sell — **~1 month ahead** of the Sept deadline below. The capacity bottleneck is cleared. The binding constraint now moves to **demand** (a repeatable acquisition engine; the pipeline is currently empty) and to **proof of solo delivery** (Milestone A2). The table below is the original April-2026 plan, retained for reference.

| Timeline | Milestone |
|----------|-----------|
| Months 1-3 (Apr-Jun 2026) | Tincho winds down 18PM commitments. Juan and Tincho define his exact ASTEROI role (client servicing + sales). |
| Months 3-6 (Jul-Sep 2026) | Tincho becomes operational face for new ASTEROI clients. Can present as growth lead without Juan being visible. |
| Months 6-12 (Oct 2026-Mar 2027) | Tincho brings on 1-2 new clients ($5-8K/month each) using inbound from Juan's content + The Starters + referrals. |

**Prerequisite for Tincho to service clients independently:** The 3 active tools (Ad Creative System, Meta Ads Deployer, Sense) must have SOPs, playbooks, and documentation so Tincho can deliver results without Juan's hands-on involvement.

### Tools: Focus, Not Expansion

**Active (invest in operationalizing):**
- Ad Creative System -- write SOPs, record Looms
- Meta Ads Deployer -- write SOPs, record Looms
- Sense (AsteroiAds) -- write SOPs, record Looms
- Google Sheets + Looker forecasting -- document the manual workflow

**Paused (resume in Phase 2 or later):**
- Triple Whale Clone
- Meta Robyn Wrapper
- Mars Men LP Generator
- Brief Generator

**Rule:** No new tool development until Tincho can run the existing three without Juan.

### Financial Targets (End of Phase 1)

| Metric | Target |
|--------|--------|
| ASTEROI gross/month | $25,000-$30,000 |
| ASTEROI clients | 4-5 |
| Juan's total personal income/month | $29,000-$32,000 |
| Cumulative savings (12 months) | ~$180,000 |
| Net worth | ~$180K (post-mortgage, rebuilding) |

### Decision Gate: Is It Time to Leave Mars Men?

Before triggering Phase 2, all three must be true:
1. ASTEROI is at $25K+/month gross with clients Tincho can service.
2. Personal brand is generating consistent inbound (DMs, inquiries, invitations).
3. Juan has 3+ months of living expenses saved beyond the mortgage.
...
**Duration:** ~6-9 months
**Objective:** Leave Mars Men, go public with ASTEROI, scale to 5-8 clients, $50-60K/month gross.

### The Transition Event

- Leave Mars Men professionally. The "Head of eComm at a $100M brand" becomes the origin story, not the current title.
- Non-compete applies to US subscription brands only. ASTEROI's client base (international, non-subscription, or non-US) does not conflict.
- Go public as ASTEROI co-founder. Update LinkedIn, Twitter, website.

### Content: The Constraint Disappears

Once Juan leaves Mars Men:
- Can discuss Meta Ads, creative strategy, full-stack growth, performance marketing.
- Content shifts from "expert sharing frameworks" to "founder of the eComm growth platform."
- Mars Men experience becomes case study material (anonymized as needed).
- ASTEROI blog restarts with Juan as the public voice.
- Possible: podcast, video content, conference talks.
...
| Metric | Target |
|--------|--------|
| ASTEROI gross/month | $50,000-$60,000 |
| ASTEROI clients | 5-8 |
| Juan's personal income/month | $32,000-$39,000 (~$400-470K/year) |
| Cumulative savings | ~$340,000-$400,000 |
...
Runs in parallel, does not affect the main strategy.

| Metric | Current | Watch for |
|--------|---------|-----------|
| Investment | $25,000 | Don't exceed $50K total |
| Monthly burn | $2,000 | Acceptable at current savings rate |
| Juan's time | Strategy only, few hrs/week | Don't let it creep above this |
| Upside | Filter subscriptions create recurring revenue | If unit economics work, could become self-sustaining |
| Downside | Total loss of ~$50-75K over 2 years | Affordable write-off |

**Decision point:** If AURAL is not self-sustaining by mid-2027, evaluate whether to continue or wind down.
...
| Tincho doesn't leave 18PM | Can't scale ASTEROI. Juan stays bottlenecked. | **RESOLVED 2026-07-20: Tincho confirmed fully operational ~early Aug 2026, ~1 month ahead of the Sept deadline.** Bottleneck cleared; risk retired. Residual watch: does he actually *deliver* solo (Milestone A2) and *sell* (pipeline)? |
...
Use this every 3 months to assess progress:
...
- **2026-07-20 (later):** **Tincho confirmed fully operational ~early Aug 2026** (~1 mo ahead of the Sept deadline) — updated the Tincho Resolution section + risk row (bottleneck cleared; constraint reframed to demand + solo-delivery proof).
